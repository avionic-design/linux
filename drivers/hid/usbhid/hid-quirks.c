...
static const struct hid_blacklist {
	...
	{ USB_VENDOR_ID_DWAV, USB_DEVICE_ID_DWAV_EGALAX_MULTITOUCH_480D, HID_QUIRK_MULTI_INPUT },
	{ USB_VENDOR_ID_DWAV, USB_DEVICE_ID_DWAV_EGALAX_MULTITOUCH_726C, HID_QUIRK_MULTI_INPUT },
